...
# 2.get error details
get_matching_error_details="SELECT requestItemId,duplicateItemId,comments_translated comments,comments_translated,verifier,cagtegoryIdDetail as cagtegoryDetail,score,fscoreDiff,grayLogDetail,trainingFeatureDetail,liveTrainingFeatureDetail,requestItemDetail,duplicateItemDetail FROM matching_error_details order by verifier,requestItemId,duplicateItemId";
